...
public class FnStaffingChangeInsert extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -1553181403;

	/**
	 * The parameter <code>ss1604c195_rd4.fn_staffing_change_insert.RETURN_VALUE</code>.
	 */
	...
	public FnStaffingChangeInsert() {
		super("fn_staffing_change_insert", Ss1604c195Rd4.SS1604C195_RD4, org.jooq.impl.DefaultDataType.getDefaultDataType("trigger"));
