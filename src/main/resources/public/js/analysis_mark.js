...
//http://7xtez1.com2.z0.glb.clouddn.com/analysis/queryPointRank?subject=Chinese&grade=M12&classno=M1201&student_id=1123
function query(){
...
//http://7xtez1.com2.z0.glb.clouddn.com/analysis/queryRadar?grade=M12&classno=M1201&student_id=1125
function xquery(){
    var subject=$("#subject").val();
...
function loadEchart(data1,data2){
    ...
    if(data1 && data1.length!=0 && data2 && data2.length!=0){
        ...
        while(p1<data1.length && p2<data2.length){
            if(data1[p1].exam_date == data2[p2].exam_date){
                ...
                series1.data.push(data1[p1].point);
                series2.data.push(data2[p2].point);
                ++p1;
                ++p2;
            }
    ...
    require.config({
                        paths: {
                            echarts: 'http://7xtez1.com2.z0.glb.clouddn.com/lib/echarts-2.2.7'
...
if((!data1 ||data1.length==0)  && (!data2 || data2.length==0)){
    option.series.push({name:'', type:'bar', data:[]});
}
