...
function loadProperties(lang){
    	jQuery.i18n.properties({//加载资浏览器语言对应的资源文件
    		name:'strings', //资源文件名称
    		path:'http://7xtez1.com2.z0.glb.clouddn.com/asset/i18n/', //资源文件路径
...
//}
//loadjscssfile("http://7xtez1.com2.z0.glb.clouddn.com/lib/jqgrid-5.1.0/js/i18n/grid.locale-"+baseLang+".js","js");
...
//	});
    ...
    try{
    	if(lang=="cn"||lang=="zh"||lang=="zh_CN"||lang=="zh-CN"|| ((baseLang=="zh"||baseLang=="cn")&&!lang))
    		$("#index_header").attr("style","background-image: url('http://7xtez1.com2.z0.glb.clouddn.com/image/XRoster_zh.png');background-size:196px;height:100px");
    	else
    		$("#index_header").attr("style","background-image: url('http://7xtez1.com2.z0.glb.clouddn.com/image/XRoster.png');background-size:160px;height:100px");
    }catch(e){}
    
    try{
    	if(lang=="cn"||lang=="zh"||lang=="zh_CN"||lang=="zh-CN"|| ((baseLang=="zh"||baseLang=="cn")&&!lang))
    		$("#logo_a").html("<img src='http://7xtez1.com2.z0.glb.clouddn.com/image/XRoster3_zh.png'/>");
    	else
    		$("#logo_a").html("<img src='http://7xtez1.com2.z0.glb.clouddn.com/image/XRoster3.png'/>");
    }catch(e){}
}
